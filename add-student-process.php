...
<?php
	...
	if(strlen($selectClass)==0 || empty($selectClass) || $selectClass==-1)
	{
		header("location:add-student.php?err=3");
		exit;
	}
	if(strlen($selectSession)==0 || empty($selectSession) || $selectSession==-1)
	{
	...
	if(strlen($studentGender)==0 || empty($studentGender) || $studentGender==-1)
	{
	...
	if(strlen($fatherNumber)==0 || empty($fatherNumber)|| strlen($fatherNumber)<10 || strlen($studentNumber)>10)
	{
		header("location:add-student.php?err=15");
		exit;
	}
	if(strlen($motherNumber)==0 || empty($motherNumber)|| strlen($motherNumber)<10 || strlen($studentNumber)>10)
	{
